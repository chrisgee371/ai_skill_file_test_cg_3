SELECT 'acceptance_tests' AS table_name, COUNT(*) AS row_count FROM chris_demos.demos.acceptance_tests
UNION ALL SELECT 'chronology_summary', COUNT(*) FROM chris_demos.demos.chronology_summary
UNION ALL SELECT 'databricks_sql_pattern_composition_rules', COUNT(*) FROM chris_demos.demos.databricks_sql_pattern_composition_rules
UNION ALL SELECT 'databricks_sql_pattern_index', COUNT(*) FROM chris_demos.demos.databricks_sql_pattern_index
UNION ALL SELECT 'databricks_sql_pattern_registry', COUNT(*) FROM chris_demos.demos.databricks_sql_pattern_registry
...
UNION ALL SELECT 'phase_plan', COUNT(*) FROM chris_demos.demos.phase_plan
