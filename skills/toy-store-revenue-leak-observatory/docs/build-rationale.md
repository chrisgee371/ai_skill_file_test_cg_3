...
This reduces server fragility, keeps logic groupings clean, and creates stable handoff boundaries between domains.

### 3. Databricks-native, data-first IR
...
### 4. Machine-readable support objects
...
### 5. Packaging aligned to the current repo layout
...
- overloading one giant pipeline with too many concerns
- losing stable handoff points between logic groups
