...
2. **Read structured inputs before reasoning from memory**
   - Read `chris_demos.demos.phase_plan`, the current stage IR table, `chris_demos.demos.source_manifest`, `docs/pipeline-topology.md`, and the profile/support tables before generating code.
...
10. **Respect the Prophecy compile loop**
