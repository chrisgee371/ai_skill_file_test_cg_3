...
with Pipeline(args) as pipeline:
    ...
    commerce_foundation__src_oi_typed = Process(
        name = "commerce_foundation__src_oi_typed",
        properties = ModelTransform(modelName = "commerce_foundation__src_oi_typed")
    )
    commerce_foundation__src_prod_typed = Process(
        name = "commerce_foundation__src_prod_typed",
        properties = ModelTransform(modelName = "commerce_foundation__src_prod_typed")
    )
    commerce_foundation__src_pv_typed = Process(
        name = "commerce_foundation__src_pv_typed",
        properties = ModelTransform(modelName = "commerce_foundation__src_pv_typed")
    )
    ...
    commerce_foundation__src_ws_typed = Process(
        name = "commerce_foundation__src_ws_typed",
        properties = ModelTransform(modelName = "commerce_foundation__src_ws_typed")
    )
    commerce_foundation__src_ord_typed = Process(
        name = "commerce_foundation__src_ord_typed",
        properties = ModelTransform(modelName = "commerce_foundation__src_ord_typed")
    )
    ...
    commerce_foundation__src_oir_typed = Process(
        name = "commerce_foundation__src_oir_typed",
        properties = ModelTransform(modelName = "commerce_foundation__src_oir_typed")
    )
